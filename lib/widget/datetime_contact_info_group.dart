...
import 'package:cupertinocontacts/widget/datetime_contact_info_text.dart';
...
///
/// 添加联系人-信息组
class DateTimeContactInfoGroup extends StatefulWidget {
  ...
  @override
  _DateTimeContactInfoGroupState createState() => _DateTimeContactInfoGroupState();
}

class _DateTimeContactInfoGroupState extends State<DateTimeContactInfoGroup> {
  ...
  Widget _buildItemAsItem(DateTimeItem item, Animation<double> animation, {VoidCallback onDeletePressed}) {
